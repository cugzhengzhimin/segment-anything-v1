...
def mask_matrix_nms(masks,
    ...
    iou_matrix = (inter_matrix /
                  (expanded_mask_area + expanded_mask_area.transpose(1, 0) -
                   inter_matrix + 1e-5)).triu(diagonal=1)
    # expanded_mask_area_cat = torch.cat([expanded_mask_area[..., None], expanded_mask_area.transpose(1, 0)[..., None]], dim=-1)
    # iou_matrix = (inter_matrix / torch.min(expanded_mask_area_cat, dim=-1)[0]).triu(diagonal=1)
